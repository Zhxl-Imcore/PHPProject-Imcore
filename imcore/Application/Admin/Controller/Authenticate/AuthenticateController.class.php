<?php
namespace Admin\Controller\Authenticate;
...
class AuthenticateController extends Controller {
	...
	public function indexAction(){
		$this->display('Authenticate:index');
	}
	...
	public function loginAction(){
        ...
        //校验通过,写入Session
       	...
       	$userModel->where(array('id'=>$record['id']))->save();
       	
       	header('Content-Type: text/html;Charset=UTF-8');
       	redirect(U('Frame/Frame/index'),1,'登录成功，正在为您跳转...');
	}
