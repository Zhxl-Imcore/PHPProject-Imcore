...
var GuoHe = {};
GuoHe.namespace = function(str){
	var arr = str.split('.'),o=GuoHe;
	for(i=(arr[0]=='GuoHe') ? 1 : 0; i<arr.length; i++){		
		o[arr[i]] = o[arr[i]] || {};
		o = o[arr[i]];
	}
}
GuoHe.namespace('page');

GuoHe.page.autoMaxWidth = function(){
...
GuoHe.page.onLoad = function(){
	...
	if (l.indexOf('about-GuoHe') > -1 && l.indexOf('about-GuoHe-psirt') < 0) {
		$('#menu a.about_GuoHe').addClass('active');
		return $('#menu').data("normal", "about-GuoHe");
	}
